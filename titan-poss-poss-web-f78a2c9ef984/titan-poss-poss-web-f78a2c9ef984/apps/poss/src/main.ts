...
async function main() {
  try {
    ...
    await platformBrowserDynamic([
      { provide: POSS_WEB_API_URL, useValue: config.apiServer.possApiURL },
      {
      ...
      {
        provide: POSS_WEB_TEMP_UNIPAY_RESPOSNE_CODE,
        useValue: config.UnipayResposeCode
      },
      {
      ...
      {
        provide: POSS_WEB_UPLOAD_EGHS_FILE_SIZE,
        useValue: config.uploadEghsFileSize
      },
      {
        provide: POSS_WEB_UPLOAD_SERVICE_POSS_FILE_SIZE,
        useValue: config.uploadServicePossFileSize
      },
      {
      ...
      {
        provide: POSS_WEB_MAX_FILE_UPLOADS,
        useValue: config.maxFileUploads
      },
      {

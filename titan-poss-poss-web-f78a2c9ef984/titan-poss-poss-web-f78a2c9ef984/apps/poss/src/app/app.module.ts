...
import { SharedCustomerFeatureCustomerSummaryModule } from '@poss-web/shared/customer/feature-customer-summary';
...
import { SharedPrintingFeaturePostTransactionConfirmationActionsModule } from '@poss-web/shared/printing/feature-post-transaction-confirmation-actions';
import { PossFindPriceFeatureFindPriceModule } from '@poss-web/poss/find-price/feature-find-price';
...
@NgModule({
  ...
  imports: [
    ...
    SharedCustomerFeatureCustomerSummaryModule,
    ...
    SharedPrintingFeaturePostTransactionConfirmationActionsModule,
    SharedBodEodFeatureBodEodModule,
    SharedComponentsUiLoaderModule,
    PossFindPriceFeatureFindPriceModule
  ],
  providers: [
    TranslateService,
    {

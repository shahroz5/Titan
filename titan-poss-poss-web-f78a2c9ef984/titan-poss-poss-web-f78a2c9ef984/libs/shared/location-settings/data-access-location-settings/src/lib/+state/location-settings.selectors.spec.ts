import * as selectors from './location-settings.selectors';
import { LocationSettingsState } from './location-settings.state';
import { initialState } from './location-settings.reducer';
import { LocationSettingDetails } from '@poss-web/shared/models';

describe('Location Settings Selector Testing Suite', () => {
  ...
  it('Testing selectLocationSettings selector', () => {
    const state: LocationSettingsState = {
      ...initialState,
      locationSettingsData: locationSettingDetails
    };
    expect(
      selectors.LocationSettingsSelectors.selectLocationSettings.projector(
        state
      )
    ).toEqual(locationSettingDetails);
  });
  it('Testing selectError selector', () => {
    ...
    expect(
      selectors.LocationSettingsSelectors.selectError.projector(state)
    ).toEqual(null);
  });
});

...
@Component({
  selector: 'poss-web-focusable-top-menu-item',
  templateUrl: './focusable-top-menu-item.component.html',
  styleUrls: ['./focusable-top-menu-item.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class FocusableTopMenuItemComponent implements FocusableOption {

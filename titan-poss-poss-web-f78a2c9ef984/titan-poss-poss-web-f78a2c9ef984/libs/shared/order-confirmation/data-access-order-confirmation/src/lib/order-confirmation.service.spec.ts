...
describe('OrderConfirmationService', () => {
  ...
  it('should be created', () => {
    expect(orderConfirmationService).toBeTruthy();
  });
  ...
  describe('updateOrder', () => {
    it('should call GET api method with correct url', () => {
      ...
      const path = getAdvanceBookingActionUrl(
        updateOrderDetails.transactionType,
        updateOrderDetails.subTransactionType,
        updateOrderDetails.cashMemoId,
        updateOrderDetails.actionType
      );
      orderConfirmationService.updateOrder(updateOrderDetails).subscribe();

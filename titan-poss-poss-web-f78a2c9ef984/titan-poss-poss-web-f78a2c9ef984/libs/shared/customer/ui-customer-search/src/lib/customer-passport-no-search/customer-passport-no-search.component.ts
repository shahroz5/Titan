...
@Component({
  selector: 'poss-web-customer-passport-no-search',
  templateUrl: './customer-passport-no-search.component.html',
  styleUrls: ['./customer-passport-no-search.component.scss']
})
export class CustomerPassportNoSearchComponent
  ...
  validKeyCheck($event: KeyboardEvent) {
    ...
    if (isValid) {
      ...
      const validLength = fieldValidation.passportIdField.maxLength;

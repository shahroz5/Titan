...
@Component({
  selector: 'poss-web-customer-ulp-id-search',
  templateUrl: './customer-ulp-id-search.component.html',
  styleUrls: ['./customer-ulp-id-search.component.scss']
})
export class CustomerUlpIdSearchComponent
  ...
  validKeyCheck($event: KeyboardEvent) {
    ...
    if (isValid) {
      ...
      const validLength = fieldValidation.ulpIdField.maxLength;

...
@Component({
  selector: 'poss-web-cn-filter-corp-user',
  templateUrl: './cn-filter-corp-user.component.html'
})
export class CnFilterCorpUserComponent implements OnInit, OnDestroy, OnChanges {
  ...
  generateReport() {
    generateCnReport(this.filterForm, this.apply, false, false);
  }
    ...
    if (this.filterForm.valid) {
      this.saveSearchParameters.emit({
        ...
        data: {
          ...
          savedQuery: {
            data: {
              fromDate: (this.filterForm.get('fromDate').value as moment.Moment)
                .startOf('day')
                .valueOf(),
              toDate: (this.filterForm.get('toDate').value as moment.Moment)
                .endOf('day')
                .valueOf(),
              ...
              regionCode: this.filterForm.get('region').value,

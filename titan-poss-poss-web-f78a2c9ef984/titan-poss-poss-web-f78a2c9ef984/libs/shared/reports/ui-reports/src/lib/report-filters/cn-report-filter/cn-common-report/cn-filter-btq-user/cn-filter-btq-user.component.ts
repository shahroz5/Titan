...
@Component({
  selector: 'poss-web-cn-filter-btq-user',
  templateUrl: './cn-filter-btq-user.component.html'
})
export class CnFilterBtqUserComponent implements OnDestroy, OnChanges {
  ...
  generateReport() {
    generateCnCommonReport(this.filterForm, this.apply, false, true);
  }

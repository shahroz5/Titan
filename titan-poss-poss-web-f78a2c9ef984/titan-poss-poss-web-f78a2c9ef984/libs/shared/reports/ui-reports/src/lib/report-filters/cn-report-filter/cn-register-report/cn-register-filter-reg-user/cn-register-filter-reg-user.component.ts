...
@Component({
  selector: 'poss-web-cn-register-filter-reg-user',
  templateUrl: './cn-register-filter-reg-user.component.html'
})
export class CnRegisterFilterRegUserComponent
  ...
  generateReport() {
    generateCnReport(this.filterForm, this.apply, true, false);
  }

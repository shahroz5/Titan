...
@Component({
  selector: 'poss-web-received-request-details',
  templateUrl: './received-request-details.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ReceivedRequestDetailsComponent implements OnChanges, OnDestroy {
  @Input() cnDetails: CNDetailsInfo;
  @Input() receivedCNDetailStatus: string;

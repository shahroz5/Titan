...
@Component({
  selector: 'poss-web-summary-bar-ab-new',
  templateUrl: './summary-bar-ab-new.component.html',
  styleUrls: ['./summary-bar-ab-new.component.scss']
})
export class SummaryBarAbNewComponent
  ...
  AB_CONFIRM_SUBMENU = 'Customer Transaction Status-AB Confirm Submenu';

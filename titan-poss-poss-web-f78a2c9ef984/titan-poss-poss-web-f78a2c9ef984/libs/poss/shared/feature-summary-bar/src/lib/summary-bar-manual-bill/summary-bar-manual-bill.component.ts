...
@Component({
  selector: 'poss-web-summary-bar-manual-bill',
  templateUrl: './summary-bar-manual-bill.component.html',
  styleUrls: ['./summary-bar-manual-bill.component.scss']
})
export class SummaryBarManualBillComponent

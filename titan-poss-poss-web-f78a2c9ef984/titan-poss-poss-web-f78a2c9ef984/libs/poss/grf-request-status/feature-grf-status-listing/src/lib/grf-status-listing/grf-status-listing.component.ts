...
@Component({
  selector: 'poss-web-grf-status-listing',
  templateUrl: './grf-status-listing.component.html',
  styleUrls: ['./grf-status-listing.component.css']
})
export class GrfStatusListingComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      this.getDropdownValue$ = this.GrfRequestFacade.getDropDownValue();
  ...
  statusChange(event) {
    ...
    this.GrfRequestFacade.setDropDownValue(event);
  }

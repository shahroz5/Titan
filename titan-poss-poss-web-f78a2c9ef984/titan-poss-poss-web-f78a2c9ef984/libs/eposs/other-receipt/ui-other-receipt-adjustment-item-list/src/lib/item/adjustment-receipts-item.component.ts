...
@Component({
  selector: 'poss-web-adjustment-receipts-item',
  templateUrl: './adjustment-receipts-item.component.html',
  styleUrls: ['./adjustment-receipts-item.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class AdjustmentReceiptsItemComponent implements OnInit, OnDestroy {
  ...
  @Output() selectedHallmark: EventEmitter<{
    selected: boolean;
  }> = new EventEmitter();
  ...
  ngOnInit() {
    ...
    this.selecthallMarkForm = new FormGroup({
  ...
  selecthallMark(event){
    if(event){
      this.hallmarkchecked = event.checked;
      //this.itemForm.value.isHallmarked.setValue(event.checked)
  ...
  // onHallmarkcheck(){
  //   this.selectedHallmark.emit({
  //         selected: this.itemForm.value.isHallmarked
  //       });
  // }
  loadImage() {

...
import { OtherReceiptDetailsComponent } from './other-receipt-details.component';
...
import { EpossOtherReceiptUiOtherReceiptItemListModule } from '@poss-web/eposs/other-receipt/ui-other-receipt-item-list';
...
@NgModule({
  declarations: [OtherReceiptDetailsComponent],
  imports: [
    ...
    EpossOtherReceiptUiOtherReceiptItemListModule,
    SharedUtilFieldValidatorsModule,
  ]
})
export class EpossOtherReceiptFeatureOtherReceiptDetailsModule {}

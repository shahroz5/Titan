...
@Component({
  selector: 'poss-web-tep-exception-remark-pop-up',
  templateUrl: './tep-exception-remark-pop-up.component.html',
})
export class TepExceptionRemarkPopUpComponent implements OnInit,OnDestroy {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TepExceptionRemarkPopUpComponent>,

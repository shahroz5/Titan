...
@Component({
  ...
  styleUrls: ['./cheque-details-pop-up.component.scss']
})
  ...
  constructor(
    ...
    this.chequeDetailsFormGroup = new FormGroup({
      chequeNumber: new FormControl('', [
        ...
        this.fieldValidatorsService.chequeDDNoField('Cheque Number')
      ]),
      payeeName: new FormControl('', [
        this.fieldValidatorsService.requiredField('Payee Name'),
        this.fieldValidatorsService.customerNameField('Payee Name')
      ]),
      bankName: new FormControl('', [
        this.fieldValidatorsService.requiredField('Bank Name'),
        this.fieldValidatorsService.bankNameField('Bank Name')
      ]),

...
import { CnMasterViewDetailComponent } from './cn-master-view-detail/cn-master-view-detail.component';
...
const routes: Routes = [
  {
    path: '',
    component: CnMasterViewDetailComponent
  }
];
...
@NgModule({
  ...
  declarations: [CnMasterViewDetailComponent]
})
export class EpossCnMasterFeatureCnMasterViewDetailModule {}

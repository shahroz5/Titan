...
@Component({
  selector: 'poss-web-adjsutment-issue-item',
  templateUrl: './adjsutment-issue-item.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class AdjsutmentIssueItemComponent implements OnInit, OnDestroy {
  readonlyqty = true;
  checkBoxValue = false;
  itemForm: FormGroup;
  destroy$ = new Subject();

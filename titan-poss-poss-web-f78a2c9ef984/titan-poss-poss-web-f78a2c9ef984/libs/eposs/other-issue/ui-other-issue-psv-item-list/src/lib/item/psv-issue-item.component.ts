...
@Component({
  selector: 'poss-web-psv-issue-item',
  templateUrl: './psv-issue-item.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class PsvIssueItemComponent implements OnInit, OnDestroy {
  ...
  createUpdateItemPayload(
    ...
    return {
      ...
      actualDetails: {
        ...
        weight: this.item.availableWeight
      }
    };
  }

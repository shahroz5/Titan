...
import { FocIssueDetailsComponent } from './foc-issue-details.component';
...
import { EpossOtherIssueUiOtherIssueFocItemListModule } from '@poss-web/eposs/other-issue/ui-other-issue-foc-item-list';
...
@NgModule({
  declarations: [FocIssueDetailsComponent],
  imports: [
    ...
    EpossOtherIssueUiOtherIssueFocItemListModule,
    EpossOtherIssueDataAccessOtherIssueModule,
    SharedUtilFieldValidatorsModule
  ]
})
export class EpossOtherIssueFeatureOtherIssueFocDetailsModule {}

import { EpossStockReceiveUiStockReceivePopupModule } from '@poss-web/eposs/stock-receive/ui-stock-receive-popup';
...
import { StockReceiveDetailsComponent } from './stock-receive-details.component';
...
@NgModule({
  declarations: [StockReceiveDetailsComponent],
  imports: [
    CommonModule,
...
export class EpossStockReceiveFeatureStockReceiveDetailsModule {}

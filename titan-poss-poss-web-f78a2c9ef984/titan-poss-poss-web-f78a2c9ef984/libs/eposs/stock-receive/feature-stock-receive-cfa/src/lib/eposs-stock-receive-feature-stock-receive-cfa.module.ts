...
import { StockReceiveCfaComponent } from './stock-receive-cfa/stock-receive-cfa.component';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild([{ path: '', component: StockReceiveCfaComponent }]),
...
export class EpossStockReceiveFeatureStockReceiveCfaModule {}

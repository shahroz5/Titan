...
import { StockReceiveFactoryComponent } from './stock-receive-factory/stock-receive-factory.component';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild([
      { path: '', component: StockReceiveFactoryComponent }
    ]),
...
export class EpossStockReceiveFeatureStockReceiveFactoryModule {}

...
import { StockReceiveMerchandiseComponent } from './stock-receive-merchandise/stock-receive-merchandise.component';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild([
      { path: '', component: StockReceiveMerchandiseComponent }
    ]),
...
export class EpossStockReceiveFeatureStockReceiveMerchandiseModule {}

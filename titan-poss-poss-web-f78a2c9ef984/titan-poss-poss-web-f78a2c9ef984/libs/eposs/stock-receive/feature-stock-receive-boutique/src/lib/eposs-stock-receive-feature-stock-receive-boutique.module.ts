...
import { StockReceiveBoutiqueComponent } from './stock-receive-boutique/stock-receive-boutique.component';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild([
      { path: '', component: StockReceiveBoutiqueComponent }
    ]),
...
export class EpossStockReceiveFeatureStockReceiveBoutiqueModule {}

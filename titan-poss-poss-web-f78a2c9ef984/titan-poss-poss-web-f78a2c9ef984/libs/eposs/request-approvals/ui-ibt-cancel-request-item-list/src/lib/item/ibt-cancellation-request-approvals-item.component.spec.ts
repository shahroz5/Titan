...
import { IbtCancellationRequestApprovalsItemComponent } from './ibt-cancellation-request-approvals-item.component';
...
class Page {
  ...
  private fixture: ComponentFixture<IbtCancellationRequestApprovalsItemComponent>;

  constructor(fixture: ComponentFixture<IbtCancellationRequestApprovalsItemComponent>) {
...
describe('IbtCancellationRequestApprovalsItemComponent', () => {
  let component: IbtCancellationRequestApprovalsItemComponent;
  let fixture: ComponentFixture<IbtCancellationRequestApprovalsItemComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [
        IbtCancellationRequestApprovalsItemComponent,
        TranslatePipeStub,
    ...
    fixture = TestBed.createComponent(IbtCancellationRequestApprovalsItemComponent);

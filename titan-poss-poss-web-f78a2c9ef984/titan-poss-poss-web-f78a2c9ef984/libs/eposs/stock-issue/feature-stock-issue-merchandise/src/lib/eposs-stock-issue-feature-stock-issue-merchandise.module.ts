...
import { StockIssueMerchandiseComponent } from './stock-issue-merchandise/stock-issue-merchandise.component';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild([
      { path: '', component: StockIssueMerchandiseComponent }
    ]),
...
export class EpossStockIssueFeatureStockIssueMerchandiseModule {}

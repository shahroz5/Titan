...
import { StockIssueFactoryComponent } from './stock-issue-factory/stock-issue-factory.component';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild([
      { path: '', component: StockIssueFactoryComponent }
    ]),
...
export class EpossStockIssueFeatureStockIssueFactoryModule {}

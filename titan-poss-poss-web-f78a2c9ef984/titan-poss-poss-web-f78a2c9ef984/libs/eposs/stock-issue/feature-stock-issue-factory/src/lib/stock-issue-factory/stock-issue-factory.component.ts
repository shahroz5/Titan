...
@Component({
  selector: 'poss-web-stock-issue-factory',
  templateUrl: './stock-issue-factory.component.html',
  styleUrls: ['./stock-issue-factory.component.scss']
})
export class StockIssueFactoryComponent

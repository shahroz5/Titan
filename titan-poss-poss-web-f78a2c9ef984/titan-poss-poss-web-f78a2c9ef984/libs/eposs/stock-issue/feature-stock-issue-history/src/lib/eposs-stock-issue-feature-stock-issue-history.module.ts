...
import { StockIssueHistoryComponent } from './stock-issue-history/stock-issue-history.component';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild([
      { path: '', component: StockIssueHistoryComponent }
    ]),
...
export class EpossStockIssueFeatureStockIssueHistoryModule {}

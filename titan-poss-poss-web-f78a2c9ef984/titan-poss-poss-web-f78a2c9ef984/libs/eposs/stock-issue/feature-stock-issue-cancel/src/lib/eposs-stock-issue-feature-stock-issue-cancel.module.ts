...
import { StockIssueCancelComponent } from './stock-issue-cancel/stock-issue-cancel.component';
...
@NgModule({
  imports: [
    CommonModule,
    RouterModule.forChild([{ path: '', component: StockIssueCancelComponent }]),
...
export class EpossStockIssueFeatureStockIssueCancelModule {}

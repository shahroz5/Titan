...
import { InStockEffects } from './update-hallmark.effect';
...
import * as InStockActions from './update-hallmark.action';

import { CustomErrorAdaptor } from '@poss-web/shared/util-adaptors';

import { newBinRequesFeatureKey } from './update-hallmark.reducers';

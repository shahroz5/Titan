...
import { WeightValueConfigEffect } from './weight-value-config.effect';
...
describe('WeightValueConfigEffect Testing Suite', () => {
  let actions$: Observable<any>;
  let effect: WeightValueConfigEffect;
  const httpClientSpy: jasmine.SpyObj<HttpClient> = jasmine.createSpyObj(
    'httpClient',
    ['get', 'post', 'patch']
  );
  const initialState = {};
  let weightValueConfigService = jasmine.createSpyObj<WeightValueConfigService>(
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [
        ...
        {
          provide: WeightValueConfigService,
          useValue: {
    ...
    effect = TestBed.inject(WeightValueConfigEffect);
    weightValueConfigService = TestBed.inject<any>(WeightValueConfigService);
  });

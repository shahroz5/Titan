...
import {
  getApprovalsAdvanceBookingCancellationUrl,
  getApprovalsHomeRouteUrl
} from '@poss-web/shared/util-site-routes';
@Component({
  selector: 'poss-web-ab-cancellation-requests-shell',
  templateUrl: './ab-cancellation-requests-shell.component.html',
  styleUrls: []
})
export class AbCancellationRequestsShellComponent implements OnInit {
  tab = 'requests';
  ...
  changeTab(newTab: any) {
    if (this.tab !== newTab) {
      ...
      this.router.navigate([
        getApprovalsAdvanceBookingCancellationUrl(this.tab)
      ]);
      console.log(
        this.router.navigate([
          'approvals/advance-booking/cancellation/',
          this.tab
        ])
      );
    }

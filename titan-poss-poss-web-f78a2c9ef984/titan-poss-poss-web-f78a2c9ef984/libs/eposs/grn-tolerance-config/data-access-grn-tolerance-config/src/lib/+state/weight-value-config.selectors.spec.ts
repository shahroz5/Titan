...
describe('GRNWeightValueConfigState selector Testing Suite', () => {
  ...
  describe('Testing GRNWeightValueConfigState related Selectors', () => {
    it('selectWeightValueConfigListing Should return the weight value config list', () => {
      ...
      const state: GRNWeightValueConfigState = {
        ...initialState,
    ...
    it('selectMappedLocationsCount   Should return total elements', () => {
      const state: GRNWeightValueConfigState = {
        ...initialState,
        mappedLocationsCount: 1
      };
      expect(
        selectors.WeightValueConfigSelectors.selectMappedLocationsCount.projector(
          state
        )
      ).toEqual(1);
    });

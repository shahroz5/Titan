...
describe('GRNWeightValueConfigService', () => {
  let httpTestingController: HttpTestingController;
  const apiUrl = 'http://localhost:3000';
  let weightValueConfigService: GRNWeightValueConfigService;
  ...
  beforeEach(() => {
    ...
    weightValueConfigService = TestBed.inject(GRNWeightValueConfigService);
  });
  ...
  describe('saveWeightValueConfigDetails', () => {
    const path = getSaveConfigFiledValueUrl(
  ...
  describe('getWeightValueConfigDetails', () => {
    const params = WeightValueConfigConstants.GRF_CONFIGURATION;
    const path = getUpdateConfigFiledValueUrl(params,
      ConfigTypeEnum.GRN_TOLERANCE_CONFIG
    );
    ...
    it('should call GET api method with correct url and params', () => {
      ...
      weightValueConfigService
        .getWeightValueConfigDetails(params)
        .subscribe();

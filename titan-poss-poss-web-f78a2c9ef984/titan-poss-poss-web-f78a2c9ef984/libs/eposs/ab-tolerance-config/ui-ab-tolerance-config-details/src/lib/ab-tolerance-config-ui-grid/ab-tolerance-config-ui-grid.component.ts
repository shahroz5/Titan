...
export const sortShortcutKey = 'AbToleranceConfigUiGridComponent.SORT';
const componentName = 'AbToleranceConfigUiGridComponent';
@Component({
  selector: 'poss-web-ab-tolerance-config-ui-grid',
  templateUrl: './ab-tolerance-config-ui-grid.component.html',
  styleUrls: ['./ab-tolerance-config-ui-grid.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class AbToleranceConfigUiGridComponent
  ...
  abToleranceConfigUiGridComponent: AbToleranceConfigUiGridComponent = this;
  ...
  ngOnInit(): void {
    ...
    this.translate
      .get([
        'pw.abWeightTolerance.metalType',
        'pw.abWeightTolerance.weightRange',
        'pw.abWeightTolerance.tolerenceInGrams',
        'pw.abWeightTolerance.tolerenceInPercent',
      ])
      .pipe(takeUntil(this.destroy$))
      .subscribe((translatedMessages: any) => {
        this.tolerenceInGrams = translatedMessages['pw.abWeightTolerance.tolerenceInGrams'];
        this.tolerenceInPercent = translatedMessages['pw.abWeightTolerance.tolerenceInPercent'];

        this.columnDefs = [
          {
            headerName: translatedMessages['pw.abWeightTolerance.metalType'],
            field: 'metalType',
            width: 130,
          ...
          {
            headerName: translatedMessages['pw.abWeightTolerance.weightRange'],
            field: 'rangeId',
            width: 130,
            cellEditorSelector: params => {
              this.objCategoryMappings = {};
          ...
          {
            headerName: translatedMessages['pw.abWeightTolerance.tolerenceInGrams'],
            field: 'configValue',
            width: 130,
            isWeight: true,
            editable: true,
          ...
          {
            headerName: translatedMessages['pw.abWeightTolerance.tolerenceInPercent'],
            field: 'configPercent',
        ...
        this.sortService.DataSource = [
          {
            id: 0,
            sortByColumnName: translatedMessages['pw.abWeightTolerance.metalType'],
            sortAscOrder: false
          },
          {
            id: 1,
            sortByColumnName: translatedMessages['pw.abWeightTolerance.weightRange'],
            sortAscOrder: false
          }
        ];
      });
          ...
          if (sortData == null || sortData.length === 0) {
            ...
            if (sortData.length > 0) {
              this.sortData.forEach(sort=>{
                switch(sort.id)
                {
                  case 0: this.sortBy = 'metalType';
                    break;
                  case 1: this.sortBy = 'rangeId.fromRange';
                    break;
                }
                if (sort.id === 0) {
  ...
  getContext() {
    return {
      ...
      componentParent: this.abToleranceConfigUiGridComponent,
      focusOn: 'configValue'
    };
  }
    ...
    for (const value of newData) {
      ...
      addSchemeDetails.push({
        ...
        rangeDetails: {
          ...
          type: ConfigTypeEnum.ORDER_AB_TOLERANCE_CONFIG
        }
      });
    }

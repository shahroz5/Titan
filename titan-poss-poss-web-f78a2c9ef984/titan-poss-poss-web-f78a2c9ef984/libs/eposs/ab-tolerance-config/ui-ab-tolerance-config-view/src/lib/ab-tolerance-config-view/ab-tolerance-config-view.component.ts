...
@Component({
  selector: 'poss-web-ab-tolerance-config-view',
  templateUrl: './ab-tolerance-config-view.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class AbToleranceConfigViewComponent implements OnInit, OnChanges {

 ...
 * @version 1.0
 */
@Repository("productSyncStagingRepository")
public interface ProductSyncStagingRepository extends JpaRepository<SyncStaging, String> {
	
	@Query("SELECT s FROM ProductSyncStaging s WHERE s.status = 'IN_PROGRESS'")

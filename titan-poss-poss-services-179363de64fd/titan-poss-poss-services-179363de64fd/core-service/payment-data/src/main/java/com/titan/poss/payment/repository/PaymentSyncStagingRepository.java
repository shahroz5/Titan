 ...
 * @version 1.0
 */
@Repository("PaymentSyncStagingRepository")
public interface PaymentSyncStagingRepository extends JpaRepository<SyncStaging, String> {
	
	@Query("SELECT s FROM PaymentSyncStaging s WHERE s.status = 'IN_PROGRESS'")

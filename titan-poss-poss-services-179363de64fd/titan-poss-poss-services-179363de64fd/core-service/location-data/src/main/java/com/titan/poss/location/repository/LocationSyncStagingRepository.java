 ...
 * @version 1.0
 */
@Repository("locationSyncStagingRepository")
public interface LocationSyncStagingRepository extends JpaRepository<SyncStaging, String> {

	@Query("SELECT s FROM LocationSyncStaging s WHERE s.status = 'IN_PROGRESS'")

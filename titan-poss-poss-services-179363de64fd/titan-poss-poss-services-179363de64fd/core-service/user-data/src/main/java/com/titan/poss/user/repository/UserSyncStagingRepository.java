 ...
 * @version 1.0
 */
@Repository("userSyncStagingRepository")
public interface UserSyncStagingRepository extends JpaRepository<SyncStaging, String> {
	
	@Query("SELECT s FROM UserSyncStaging s WHERE s.status = 'IN_PROGRESS'")

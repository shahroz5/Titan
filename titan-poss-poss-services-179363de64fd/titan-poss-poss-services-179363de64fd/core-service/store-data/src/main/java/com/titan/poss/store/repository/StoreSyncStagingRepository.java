 ...
 * @version 1.0
 */
@Repository("StoreSyncStagingRepository")
public interface StoreSyncStagingRepository extends JpaRepository<SyncStaging, String>{
	
	@Query("SELECT s FROM StoreSyncStaging s WHERE s.status = 'IN_PROGRESS'")

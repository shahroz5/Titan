 ...
 * @version 1.0
 */
@Repository("configSyncStagingRepository")
public interface ConfigSyncStagingRepository extends JpaRepository<SyncStaging, String> {
	
	@Query("SELECT s FROM ConfigSyncStaging s WHERE s.status = 'IN_PROGRESS'")

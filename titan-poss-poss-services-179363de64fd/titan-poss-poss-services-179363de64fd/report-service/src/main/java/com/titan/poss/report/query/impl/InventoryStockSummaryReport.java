...
@Service("stockInventorySummaryReport")
public class InventoryStockSummaryReport extends IReport {

	/**
	 * @param reportFactory
	 */
	public InventoryStockSummaryReport(ReportFactory reportFactory) {
		reportFactory.registerReportQuery("STOCK_SUMMARY_REPORT", this);
	}
	...
	public String buildQuery(ReportRequestDto reportRequestDto) {
		...
		String select = "SELECT     " +
                ...
                "sum(inv.total_quantity) as \"Stock Quantity\",  " +
                "sum(inv.std_weight) as \"Unit Weight\",  " +
                "sum(inv.std_value)as \"Stock Value\"   " +
                " FROM   " +
		...
		String groupBy = " GROUP BY " +
				...
				"inv.product_group," +
				"pgm.description," +
				"pcm.description, bmv.brand_code, bmv.country_code ";
		//@formatter:on
	...
	protected StringBuilder appendQuery(ReportRequestDto reportRequestDto) {
		...
		validateCustomFieldsAndAppend(stockInventoryRequestDto, query);
		return query;
	}
	...
	private StringBuilder validateCustomFieldsAndAppend(StockInventoryRequestDto stockInventoryRequestDto,
			StringBuilder query) {

...
@Component("liveStockInventoryDetailsReport")
public class InventoryLiveStockDetailsReport extends IReport {

	public InventoryLiveStockDetailsReport(ReportFactory reportFactory) {
		reportFactory.registerReportQuery("LIVE_STOCK_DETAIL_REPORT ", this);
	}

...
/**
 * 
 * Email Send Task Listener for L2 Approver
 * 
 * @author Mindtree Ltd.
 * @version 1.0
 */

public class TaskAssignmentListenerL2 implements TaskListener {
	
	private static final Logger LOGGER = Logger.getLogger(TaskAssignmentListenerL2.class.getName());
	...
	public void notify(DelegateTask delegateTask) {
		delegateTask.setVariable("taskIdL2", delegateTask.getId());		
		
		  String taskApprover = (String) delegateTask.getVariable("approverL2");
		  String taskApproverEmail = (String) delegateTask.getVariable("approverEmailL2");		  

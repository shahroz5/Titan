          ...
          >
            ...
            <thead bgcolor="#7e6e38">
              <tr>
                ...
                >
                  Credit Note Usage by other person
                </td>
              </tr>
            </thead>
            <tbody
              ...
              <tr>
               ...
               <tr>
                <td style="padding: 0px 30px;">
                  We have received a request from other customer to use your credit note.
                </td>
              </tr>
             <tr>
                <td style="padding: 0px 30px;">
                  Please find the OTP: <b>${otp}</b> for your credit note No. <b>${CN_DOC_NO}</b>.
                </td>
              </tr>
              <tr>

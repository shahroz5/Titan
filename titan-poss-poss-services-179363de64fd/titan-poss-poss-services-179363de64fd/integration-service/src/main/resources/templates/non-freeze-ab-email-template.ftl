            ...
            >
              ...
              <tr>
                <td style="padding: 0px 30px 30px">
                  ...
                  <b>${docDate}</b>, Location Code: ${locationCode}. The Gold rate
                  will be 'as per the invoicing' for this booking. However, If
                  you wish to fix the gold rate, Please visit Tanishq showroom
                  with the order copy for more information. FYI and T and C
                  Apply.
                </td>
              </tr>

      ...
      <tr>
        <td style="padding: 10px 0 30px 0">
          ...
          >
            ...
            >
              <tr>
                <td style="padding: 20px 30px">Dear ${name!"Customer"},</td>
              </tr>
              <tr>
                <td style="padding: 0px 30px 30px">
                  We are pleased to inform you that your Invoice Copy is attached as
                  PDF. Thank you for shopping at ${brandCode!"Tanishq"}.
                </td>
              </tr>
              <tr>
             <#if (address)??>
	              <tr>
	                <td style="padding: 0px 30px">Address: ${address}</td>
	              </tr>
              </#if>
               <#if (pincode)??>
	              <tr>
	                <td style="padding: 0px 30px">PinCode: ${pincode}</td>
	              </tr>
              </#if>
              <#if (phoneNumber)??>
	              <tr>
	                <td style="padding: 0px 30px 30px">Ph: ${phoneNumber}</td>
	              </tr>
	          </#if>

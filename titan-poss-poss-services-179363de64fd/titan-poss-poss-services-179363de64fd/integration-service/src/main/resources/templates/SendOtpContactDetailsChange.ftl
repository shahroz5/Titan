              ...
              <tr>
               ...
               <tr>
                <td style="padding: 0px 30px;">
                  We have received a request to change your ${contactType} to ${reqValue}
                </td>
              </tr>
             <tr>
                <td style="padding: 0px 30px;">
                  Please use the OTP: <b>${otp}</b> to log in and change your password
                  with your corporate ID as the Username.
                </td>
              </tr>
              <tr>
                <td style="padding: 0px 30px;">
                  Your OTP is valid till <b>${expiryTime}, ${expiryDate}</b>. Upon expiry, contact head of organization.
                </td>
              </tr>

              <tr>
                <td style="padding: 0px 30px;">
                  You can click here to proceed or alternatively type the
                  following in the
                </td>
              </tr>
              <tr>
                <td style="padding: 0px 30px;">
                  browser:
                  <a href="#" target="_blank">https://www.titanposs.co.in</a>
                </td>
              </tr>
              <tr>
                <td style="padding: 30px 30px 0px;">
If you do not want to change your contact details, please ignore this message and your password will not be changed.
				</td>
              </tr>
              <tr>
                <td style="padding: 0px 30px;">
                  a confirmation has been sent to the USERS emal/mobile with
                  OTP.
                </td>
              </tr>
              <tr>

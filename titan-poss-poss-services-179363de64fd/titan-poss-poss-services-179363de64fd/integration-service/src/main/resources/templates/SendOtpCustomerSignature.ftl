      ...
      <tr>
        <td style="padding: 10px 0 30px 0">
          ...
          >
            ...
            >
              <tr>
                <td style="padding: 20px 30px">Dear ${name!"User"},</td>
              </tr>
              <tr>
                <td style="padding: 0px 30px">
                  Your OTP Number <b>${otp}</b> for authorizing and accepting the billing and related transactions 
                  being done today at ${storeAddress}. This OTP is valid only for 15 mins. For any clarifications please contact ${storeNumber}.
                </td>
              </tr>
              <tr>

              ...
              <tr>
               ...
               <tr>
                <td style="padding: 0px 30px;">
                  We have received a request to reset the password for your account on ${date} at ${time}
                </td>
              </tr>
             <tr>
                <td style="padding: 0px 30px;">
                  Please use the OTP: <b>${otp}</b> to log in and change your password
                  with your corporate ID as the user name.
                </td>
              </tr>
              <tr>
                <td style="padding: 0px 30px;">
...
If you do not want to reset your password, please ignore this message and your password will not be changed.
				</td>
              </tr>
              <tr>
                <td style="padding: 0px 30px;">

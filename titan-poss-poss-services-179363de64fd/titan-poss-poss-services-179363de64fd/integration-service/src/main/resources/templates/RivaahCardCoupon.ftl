              ...
              <tr>
               ...
               <tr>
                <td style="padding: 0px 30px;">
                  Please Find your RIVAAH CARD coupon here: <b>${coupon}</b>
                </td>
              </tr>
             <tr>
                <td style="padding: 0px 30px;">
                You can redeem it total number of <b>${totalCount}</b> times before <b>${expiryDate}</b>
                </td>
              </tr>
               <tr>
                <td style="padding: 0px 30px;">
                Your current redemption count is: <b>${attempts}</b>
                </td>
              </tr>
              <tr>

          ...
          >
            ...
            <thead bgcolor="#7e6e38">
              <tr>
                ...
                >
                  GHS account Usage by other person
                </td>
              </tr>
            </thead>
            <tbody
              ...
              <tr>
               ...
               <tr>
                <td style="padding: 0px 30px;">
                  We have received a request from other customer to use your GHS account.
                </td>
              </tr>
             <tr>
                <td style="padding: 0px 30px;">
                  Please find the OTP: <b>${otp}</b> for your GHS account No. <b>${GHS_ACCT_NO}</b>.
                </td>
              </tr>
              <tr>

          ...
          >
            ...
            <thead bgcolor="#7e6e38">
              <tr>
                ...
                >
                  Customer Document Upload Validation
                </td>
              </tr>
            </thead>
            <tbody
              ...
              <tr>
               ...
               <tr>
                <td style="padding: 0px 30px;">
                  We have received a request for validating your uploaded document.
                </td>
              </tr>
             <tr>
                <td style="padding: 0px 30px;">
                  Please find the OTP: <b>${otp}</b> to validate your <b>${FILE_TYPE}</b>.
                </td>
              </tr>
              <tr>

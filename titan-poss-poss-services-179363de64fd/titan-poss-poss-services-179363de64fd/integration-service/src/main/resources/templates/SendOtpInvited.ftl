            ...
            >
              ...
              <tr>
                <td style="padding: 0px 30px 15px;">
                  Your account has been created in Titan POSS.<br>
                  Your Username is <b><i>${userName}</i></b><br>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td style="padding: 30px 30px 0px;">
                  USER NAME has been added successfully and
                </td>
              </tr>
              <tr>
                <td style="padding: 0px 30px;">
                  a confirmation has been sent to the USERS email/mobile with
                  OTP.
                </td>
              </tr>
              <tr>

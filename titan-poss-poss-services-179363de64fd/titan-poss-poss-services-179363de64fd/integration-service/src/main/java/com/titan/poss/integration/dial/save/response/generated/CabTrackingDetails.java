...
@XmlRootElement(name = "CabTrackingDetails", namespace = "http://dynamicverticals.com/")
public class CabTrackingDetails {

    @XmlElement(namespace = "http://dynamicverticals.com/")

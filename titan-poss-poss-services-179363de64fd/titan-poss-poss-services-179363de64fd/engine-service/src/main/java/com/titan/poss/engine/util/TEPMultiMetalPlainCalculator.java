...
public class TEPMultiMetalPlainCalculator extends TEPPlainCalculator{
	
	public TEPMultiMetalPlainCalculator(String locationCode, ItemDao itemDto, ProductGroupDao productGroupDetail,

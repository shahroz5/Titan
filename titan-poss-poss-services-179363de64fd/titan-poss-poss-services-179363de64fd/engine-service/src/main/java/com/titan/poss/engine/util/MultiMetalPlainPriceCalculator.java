...
public class MultiMetalPlainPriceCalculator extends PlainPriceCalculator {
	...
	public MultiMetalPlainPriceCalculator(String locationCode, ItemDao itemDto, InventoryDetailsDao inventoryDetail,

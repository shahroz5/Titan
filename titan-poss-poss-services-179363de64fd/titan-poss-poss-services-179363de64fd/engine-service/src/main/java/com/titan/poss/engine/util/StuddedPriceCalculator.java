...
public class StuddedPriceCalculator extends NonUcpPriceCalculator {

	@Override
	public void v(PriceUtilService priceUtilService) {

		priceResponseData = priceUtilService.studdedVCalculation(priceResponseData, itemDto, measuredWeight,
				measuredQuantity, inventoryDetail, locationCode, standardPrice);
	...
	public void f1(PriceUtilService priceUtilService) {
		...
		priceResponseData = priceUtilService.studdedF1Calculation(priceResponseData, inventoryDetail, locationCode);

	}

	@Override
	public void f2(PriceUtilService priceUtilService) {
		priceResponseData = priceUtilService.studdedF2Calculation(priceResponseData, itemDto, locationCode,inventoryDetail);
	}

	public StuddedPriceCalculator(String locationCode, ItemDao itemDto, InventoryDetailsDao inventoryDetail,

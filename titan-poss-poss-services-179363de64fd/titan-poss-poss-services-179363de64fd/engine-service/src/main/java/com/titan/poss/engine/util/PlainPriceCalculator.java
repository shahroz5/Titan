...
public class PlainPriceCalculator extends NonUcpPriceCalculator {

	@Override
	public void v(PriceUtilService priceUtilService) {
		// measured_weight is a metal_std_weight
		priceUtilService.plainVCalculation(locationCode, inventoryDetail, itemDto, priceResponseData, measuredWeight,
				measuredQuantity, standardPrice);
	}

	@Override
	public void f1(PriceUtilService priceUtilService) {

		priceResponseData = priceUtilService.plainF1Calculation(priceResponseData);
	...
	public PlainPriceCalculator(String locationCode, ItemDao itemDto, InventoryDetailsDao inventoryDetail,

...
@EnableJpaRepositories(basePackages = {
		"com.titan.poss.engine.config" }, entityManagerFactoryRef = "configDataEntityManager", transactionManagerRef = "configDataTransactionManager")
...
public class ConfigDBManager extends BaseConfig {
	...
	@Bean("configDataTransactionManager")

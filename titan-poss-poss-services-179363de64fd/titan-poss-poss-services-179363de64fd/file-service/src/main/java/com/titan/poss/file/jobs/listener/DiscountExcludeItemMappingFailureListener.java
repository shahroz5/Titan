...
@Slf4j
@Component
public class DiscountExcludeItemMappingFailureListener
		implements SkipListener<DiscountExcludeItemMappingDto, DiscountExcludeItemMappingDto> {
	...
	@Override
	public void onSkipInWrite(DiscountExcludeItemMappingDto item, Throwable t) {
		DataAuditDto dataAudit = new DataAuditDto();
		dataAudit.setPrimaryData(item.getDiscountId());
	...
	@Override
	public void onSkipInProcess(DiscountExcludeItemMappingDto item, Throwable t) {

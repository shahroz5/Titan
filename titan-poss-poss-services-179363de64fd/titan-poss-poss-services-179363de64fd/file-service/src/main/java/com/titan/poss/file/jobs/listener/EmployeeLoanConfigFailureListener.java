...
@Slf4j
@Component
public class EmployeeLoanConfigFailureListener  implements SkipListener<EmployeeLoanConfigWriterDto, EmployeeLoanConfigWriterDto>{
	...
	@Override
	public void onSkipInWrite(EmployeeLoanConfigWriterDto item, Throwable t) {
		DataAuditDto dataAudit = new DataAuditDto();
		dataAudit.setPrimaryData(item.getLocationCodes());
	...
	@Override
	public void onSkipInProcess(EmployeeLoanConfigWriterDto item, Throwable t) {

...
@Slf4j
@Component
public class ItemGroupLevelDiscountIngestionFailureListener
		implements SkipListener<ItemGroupLevelDiscountDto, DiscountItemMappingDao> {
	...
	@Override
	public void onSkipInWrite(DiscountItemMappingDao item, Throwable t) {
		DataAuditDto dataAudit = new DataAuditDto();
		dataAudit.setPrimaryData(item.getId());

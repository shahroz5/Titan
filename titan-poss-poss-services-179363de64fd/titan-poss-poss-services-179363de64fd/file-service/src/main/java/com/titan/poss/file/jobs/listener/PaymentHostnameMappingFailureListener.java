...
@Slf4j
@Component
public class PaymentHostnameMappingFailureListener implements SkipListener<PaymentHostnameMappingDto, PaymentHostnameMappingDto> {
	...
	@Override
	public void onSkipInWrite(PaymentHostnameMappingDto item, Throwable t) {
	...
	@Override
	public void onSkipInProcess(PaymentHostnameMappingDto item, Throwable t) {

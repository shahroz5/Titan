...
@Component
public class StnAndInvoiceLotMaterialDetailsDataSyncWriter
		implements ItemWriter<LotMaterialDetailsDao>, StepExecutionListener {
	...
	@Override
	public void write(List<? extends LotMaterialDetailsDao> lotMaterials) throws Exception {

		SyncStagingDto data = stnAndInvoiceService.getLotMaterialsStagingDto((List<LotMaterialDetailsDao>) lotMaterials,
				locationCode);

...
@Slf4j
@Component
public class PayerBankFailureListener implements SkipListener<PayerBankDto, PayerBankDto> {
	...
	@Override
	public void onSkipInWrite(PayerBankDto item, Throwable t) {
		DataAuditDto dataAudit = new DataAuditDto();
		dataAudit.setPrimaryData(item.getBankName());
	...
	@Override
	public void onSkipInProcess(PayerBankDto item, Throwable t) {

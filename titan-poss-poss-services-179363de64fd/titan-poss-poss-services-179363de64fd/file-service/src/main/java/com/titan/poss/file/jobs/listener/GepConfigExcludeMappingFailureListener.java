...
@Slf4j
@Component
public class GepConfigExcludeMappingFailureListener implements SkipListener<GepConfigExcludeMappingDto, GepConfigExcludeMappingDto> {
	...
	@Override
	public void onSkipInWrite(GepConfigExcludeMappingDto item, Throwable t) {
		DataAuditDto dataAudit = new DataAuditDto();
		dataAudit.setPrimaryData(item.getConfigId());
	...
	@Override
	public void onSkipInProcess(GepConfigExcludeMappingDto item, Throwable t) {

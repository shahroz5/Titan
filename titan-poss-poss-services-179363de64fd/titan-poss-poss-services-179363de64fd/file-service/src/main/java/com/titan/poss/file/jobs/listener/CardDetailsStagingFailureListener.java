...
@Slf4j
@Component
public class CardDetailsStagingFailureListener implements SkipListener<CardDetailsDto, CardDetailsDto> {
	...
	@Override
	public void onSkipInWrite(CardDetailsDto item, Throwable t) {

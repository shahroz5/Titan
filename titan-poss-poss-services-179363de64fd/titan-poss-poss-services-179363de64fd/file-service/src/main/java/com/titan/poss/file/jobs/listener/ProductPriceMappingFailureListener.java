...
@Slf4j
@Component
public class ProductPriceMappingFailureListener implements SkipListener<ProductPriceMappingDto, ProductPriceMappingDto> {
	...
	@Override
	public void onSkipInWrite(ProductPriceMappingDto item, Throwable t) {
		DataAuditDto dataAudit = new DataAuditDto();
		dataAudit.setPrimaryData(item.getProductGroupCode());
	...
	@Override
	public void onSkipInProcess(ProductPriceMappingDto item, Throwable t) {

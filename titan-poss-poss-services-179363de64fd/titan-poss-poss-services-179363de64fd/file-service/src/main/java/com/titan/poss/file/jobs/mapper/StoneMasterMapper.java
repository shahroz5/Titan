...
@Component
public class StoneMasterMapper implements RowMapper<StoneDao> {

	@Override
	public StoneDao mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		stoneTypeDao.setStoneTypeCode(rs.getString("stone_type_code"));

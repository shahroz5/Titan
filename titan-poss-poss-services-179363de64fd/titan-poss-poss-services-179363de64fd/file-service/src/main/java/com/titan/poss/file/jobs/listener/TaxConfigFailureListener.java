...
@Slf4j
@Component
public class TaxConfigFailureListener implements SkipListener<TaxConfigDto, TaxConfigDto> {
	...
	@Override
	public void onSkipInWrite(TaxConfigDto item, Throwable t) {
		DataAuditDto dataAudit = new DataAuditDto();
		dataAudit.setPrimaryData(item.getTransactionType());
	...
	@Override
	public void onSkipInProcess(TaxConfigDto item, Throwable t) {

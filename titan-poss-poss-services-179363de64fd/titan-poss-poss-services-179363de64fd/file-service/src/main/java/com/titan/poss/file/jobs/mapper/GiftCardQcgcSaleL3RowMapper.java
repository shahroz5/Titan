...
@Component
public class GiftCardQcgcSaleL3RowMapper implements RowMapper<DebitNoteDto> {
	...
	public DebitNoteDto mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		debitNoteDto.setTransactionType("QCCARDSALE");
		...
		debitNoteDto.setMemoLine("GIFT CARD SALE");

...
@Slf4j
@Component
public class ItemGroupLevelDiscountStagingFailureListener
		implements SkipListener<ItemGroupLevelDiscountDto, ItemGroupLevelDiscountDto> {
	...
	@Override
	public void onSkipInWrite(ItemGroupLevelDiscountDto item, Throwable t) {
		DataAuditDto dataAudit = new DataAuditDto();
		dataAudit.setPrimaryData(item.getItemCode());
	...
	@Override
	public void onSkipInProcess(ItemGroupLevelDiscountDto item, Throwable t) {

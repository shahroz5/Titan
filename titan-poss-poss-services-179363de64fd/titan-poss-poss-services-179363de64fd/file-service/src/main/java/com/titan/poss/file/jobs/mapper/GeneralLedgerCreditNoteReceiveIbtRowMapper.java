...
public class GeneralLedgerCreditNoteReceiveIbtRowMapper implements RowMapper<GeneralLedgerDto> {
	...
	public GeneralLedgerDto mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		String attribute5 = StringUtils.isEmpty(rs.getString("debit_amount")) ? "CN" + destLocationCode + rs.getString("dest_cn_doc_no")
				:"CN" + srcLocationCode + rs.getString("src_cn_doc_no");
		...
		generalLedger.setAttribute3(destLocationCode);

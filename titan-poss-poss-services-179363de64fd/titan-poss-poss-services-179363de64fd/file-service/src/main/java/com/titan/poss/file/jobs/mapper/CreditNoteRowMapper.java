...
@Component
public class CreditNoteRowMapper implements RowMapper<DebitNoteDto> {
	...
	public DebitNoteDto mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		debitNoteDto.setTransactionType(rs.getString(FileIntegrationConstants.LOCATION_CODE) + "CN");

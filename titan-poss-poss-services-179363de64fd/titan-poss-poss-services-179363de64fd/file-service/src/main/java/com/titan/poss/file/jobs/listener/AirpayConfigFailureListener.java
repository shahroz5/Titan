...
@Slf4j
@Component
public class AirpayConfigFailureListener implements SkipListener<AirpayConfigDto, AirpayConfigDto> {
	...
	@Override
	public void onSkipInWrite(AirpayConfigDto item, Throwable t) {
	...
	@Override
	public void onSkipInProcess(AirpayConfigDto item, Throwable t) {

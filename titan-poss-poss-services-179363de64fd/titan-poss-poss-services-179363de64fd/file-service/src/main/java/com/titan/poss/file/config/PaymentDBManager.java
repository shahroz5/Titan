...
@EnableJpaRepositories(basePackages = "com.titan.poss.payment", entityManagerFactoryRef = "paymentDataEntityManager", transactionManagerRef = "paymentDataTransactionManager")

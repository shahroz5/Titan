...
public class MaterialSyncDto extends MasterSyncableEntity {
	...
	public MaterialDatasyncStageDao getMaterialDatasyncStageDao(MaterialSyncDto itemSyncDto) {
		MaterialDatasyncStageDao materialDao = new MaterialDatasyncStageDao();
		materialDao = (MaterialDatasyncStageDao) MapperUtil.getObjectMapping(itemSyncDto, materialDao);

		return materialDao;
	}

	public List<MaterialDatasyncStageDao> getMaterialDatasyncStageDaoDaoList(List<MaterialSyncDto> syncDtoList) {

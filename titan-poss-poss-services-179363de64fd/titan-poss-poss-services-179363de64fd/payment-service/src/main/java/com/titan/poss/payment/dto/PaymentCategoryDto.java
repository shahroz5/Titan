 ...
 * @version 1.0
 */
@ApiModel(description = "Payment Category Dto")
@Data
public class PaymentCategoryDto {

	@Size(min = 1, max = 100, message = "paymentCategoryName min length {min} and max length is {max}")
	@PatternCheck(regexp = RegExConstants.DESCRIPTION_REGEX_SPCL_CHAR_MAX_100)
	@ApiModelProperty(position = 1, value = "Name of the Payment category", name = "paymentCategoryName", required = true, example = "Retail")
	private String paymentCategoryName;

	@ApiModelProperty(position = 8, value = "Name of the description", name = "description", required = true, example = "Retail Group")
	private String description;

	@Size(min = 1, max = 20, message = "paymentCode min length {min} and max length is {max}")
	@ApiModelProperty(position = 2, value = "Code of the payment code", name = "paymentCode", required = true, example = "QCGC")
	...
	@ApiModelProperty(position = 3, value = "Multiple Card series", name = "instrumentNumber Details", required = true)

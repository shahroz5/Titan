 ...
 * @version 1.0
 */
@SpringBootTest(classes = PaymentServiceApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = "spring.profiles.active=test")
...
public class PaymentBase {
	...
	protected String createURLWithPort(String uri) {
		return "http://localhost:" + port + "/payment/v2/" + uri;
	}

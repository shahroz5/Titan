...
import com.titan.poss.config.ConfigApplication;
 ...
 * @version 1.0
 */
@SpringBootTest(classes = ConfigApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = "spring.profiles.active=test")
...
public class ConfigBase {
	...
	protected String createURLWithPort(String uri) {
		return "http://localhost:" + port + "config/v2/" + uri;
	}

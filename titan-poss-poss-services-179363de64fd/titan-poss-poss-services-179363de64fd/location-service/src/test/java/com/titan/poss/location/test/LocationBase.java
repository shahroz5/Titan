package com.titan.poss.location.test;
...
import com.titan.poss.location.LocationApplication;

@SpringBootTest(classes = LocationApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = "spring.profiles.active=test")
...
public class LocationBase {
	...
	protected String createURLWithPort(String uri) {
		return "http://localhost:" + port + "/location/v2/" + uri;
	}

	protected static String generateString(int length) {
		String characters = "ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz";

 ...
 * @version 1.0
 */
@SpringBootTest(classes = SalesApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = "spring.profiles.active=test")
...
public class SalesBase {
	...
	protected String createURLWithPort(String uri) {
		return "http://localhost:" + port + "/sales/v2/" + uri;
	}

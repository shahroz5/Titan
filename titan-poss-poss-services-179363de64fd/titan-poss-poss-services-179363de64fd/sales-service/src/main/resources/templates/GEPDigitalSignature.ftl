...
<html lang="en">
  ...
  <body>
    <div class="pw-content">
     <div style="text-align:right">${prints!}</div>
      ...
      <div class="row">
        <div class="col-auto" style="text-align: center">
          <h3>GENERAL EXCHANGE PROGRAM</h3>
        </div>
      </div>
      ...
      <div class="pw-body-content">
        ...
        <div style="margin-top: 20px">Dear Sir,</div>
        <div style="margin-top: 10px">
          I voluntarily offer my jewellery that I have purchased from other
          Jewellers for the purpose of exchanging the same under the General
          Exchange Program, Tanishq
        </div>
        ...
        <div style="margin-top: 5px">
          <ol class="pw-confirmation-box__item">
            <li class="pw-confirmation-box__margin-top-5">
              For melting the jewellery given by me to assess the final purity
              and losses if any, during the process due to dirt, volatile
              impurity etc.
            </li>
            <li class="pw-confirmation-box__margin-top-5">
              That in case I take back or the company gives back the jewellery
              for any reason after melting before exchange / billing, it will
              not be returned in the original form and weight.
            </li>
            <li class="pw-confirmation-box__margin-top-5">
              To the result of the purity test, weight of the gold, the
              estimated value of my gold including Standard deduction.
            </li>
          </ol>
        </div>

...
public interface PrintService {
	 ...
	 * @return
	 */
	ResponseEntity<Resource> rePrintDocument(String documentType, String productCode, String fileType,
			String transactionId, String invoiceType,PrintRequestDto printRequest);

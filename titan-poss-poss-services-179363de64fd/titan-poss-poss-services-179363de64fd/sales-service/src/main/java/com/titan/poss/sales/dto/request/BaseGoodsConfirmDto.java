 ...
 */
@Data
public class BaseGoodsConfirmDto {
	...
	@Positive(message = "Final value must be greater than 0")
	...
	@Positive(message = "totalQuantity should be more than 0")
	private Short totalQuantity;

	@NotNull(message = "Please provide Total Tax")
	@Min(value=0, message="Total Tax should not be negative")
	...
	@ValueOfEnum(enumClass = TepPaymentTypeEnum.class)

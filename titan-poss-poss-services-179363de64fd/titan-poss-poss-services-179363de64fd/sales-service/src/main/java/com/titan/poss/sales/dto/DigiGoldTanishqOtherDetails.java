...
public class DigiGoldTanishqOtherDetails extends BasePaymentFieldsDto {

	@NotNull(message = "Please provide mobileNo")
	private String mobileNo;

	@NotNull(message = "Please provide tanishq Gold Grams to be redeemed")
	private BigDecimal tanishqGoldrams;

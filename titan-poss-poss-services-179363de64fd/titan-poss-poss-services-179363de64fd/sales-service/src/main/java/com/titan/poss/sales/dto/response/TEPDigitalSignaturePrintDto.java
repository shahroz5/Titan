...
@AllArgsConstructor
@NoArgsConstructor
public class TEPDigitalSignaturePrintDto implements PrintableDto {
	...
	public CustomerDocumentDto getDocumentDetails() {
		...
		customerDocument.setDocumentType(PrintDocumentTypeEnum.TEP_DIGITAL_SIGNATURE.name());
	...
	public List<String> getTemplateName() {
		return List.of(FtlTemplateName.TEP_DIGITAL_SIGNATURE);
	}
}

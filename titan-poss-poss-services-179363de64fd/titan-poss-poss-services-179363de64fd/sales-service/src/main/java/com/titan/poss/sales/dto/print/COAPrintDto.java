...
@AllArgsConstructor
@NoArgsConstructor
public class COAPrintDto implements PrintableDto {
	...
	public List<String> getTemplateName() {
		return List.of(FtlTemplateName.COA_INVOICE_EMAIL, FtlTemplateName.COA_INVOICE_PRINT);
	}
	...
	public CustomerDocumentDto getDocumentDetails() {
		...
		customerDocument.setDocumentType(PrintDocumentTypeEnum.COA.name() +"_" + itemDetails.getItemCode());

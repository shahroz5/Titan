...
public class RateFreezePrintDto implements PrintableDto {
	...
	public List<String> getTemplateName() {
		return List.of(FtlTemplateName.RATE_FREEZE_PRINT);
	}
	...
	public CustomerDocumentDto getDocumentDetails() {
		...
		customerDocument.setDocumentType(PrintDocumentTypeEnum.GRF.name());

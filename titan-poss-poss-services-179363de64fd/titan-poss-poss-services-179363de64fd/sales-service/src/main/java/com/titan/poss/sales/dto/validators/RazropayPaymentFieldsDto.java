...
/**
 * DTO class for 'RAZRO PAY' payment.
 * 
 * @author Mindtree Ltd.
 * @version 1.0
 */
...
public class RazropayPaymentFieldsDto extends BasePaymentFieldsDto {
	...
	@PatternCheck(regexp = RegExConstants.DESCRIPTION_REGEX_SPCL_CHAR_MAX_100, message = "Please provide reference 1(Razor Pay transaction id) of max length is 100")

...
@AllArgsConstructor
@NoArgsConstructor
public class CreditNoteCancellationPrintDto implements PrintableDto{
	...
	private String pvPaymentMode;
	private Integer debitNoteDocNo;
	private Short debitNoteFiscalYear;
	...
	public List<String> getTemplateName() {
		return List.of(FtlTemplateName.CREDIT_NOTE_CANCELLATION_INVOICE_PRINT);
	}
	...
	public CustomerDocumentDto getDocumentDetails() {
		...
		customerDocument.setDocumentType(PrintDocumentTypeEnum.CREDIT_NOTE_CANCELLATION.name());

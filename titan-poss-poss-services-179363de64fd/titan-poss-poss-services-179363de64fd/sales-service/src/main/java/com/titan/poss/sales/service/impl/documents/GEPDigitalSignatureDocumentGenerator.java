...
import com.titan.poss.sales.dto.response.GEPDigitalSignaturePrintDto;
...
@Service
public class GEPDigitalSignatureDocumentGenerator extends SalesDocumentGenerator implements DocumentGenerator {
	...
	public GEPDigitalSignatureDocumentGenerator(DocumentFactory documentFactory) {
		documentFactory.registerDocumentService(PrintDocumentTypeEnum.GEP_DIGITAL_SIGNATURE.name(),
	...
	private GEPDigitalSignaturePrintDto getftlBindingObjectForTEP(String custId) {
		GEPDigitalSignaturePrintDto tepDigitalSignaturePrintDto = new GEPDigitalSignaturePrintDto();
	...
	public PrintableDto getDto() {
		// TODO Auto-generated method stub
		return new GEPDigitalSignaturePrintDto();
	}

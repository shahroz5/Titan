...
/**
 * Service class for Category Discount
 * 
 * @author Mindtree Ltd.
 * @version 1.0
 */

@Service("salesCatgeoryDiscountServiceImpl")
public class CategoryDiscountServiceImpl implements DiscountService {

	@Autowired
	private DiscountUtilService discountUtilService;

	public CategoryDiscountServiceImpl(DiscountFactory discountFactory) {
		discountFactory.registerDiscountService(DiscountTypeEnum.CATEGORY_DISCOUNT.name(), this);
	}
	...
	public DiscountDetailsDaoExt addDiscount(SalesTxnDaoExt salesTxn, DiscountDetailDto discountDetail,
		...
		DiscountDetailsDaoExt discountDetailsDao = discountUtilService.createDiscountDetails(discountDetail, salesTxn,
				...
				DiscountInitialStatusEnum.CATEGORY_DISCOUNT.getDiscountInitialStatus(), null);

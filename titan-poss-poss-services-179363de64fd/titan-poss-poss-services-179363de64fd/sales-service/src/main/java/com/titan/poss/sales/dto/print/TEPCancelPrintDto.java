...
@AllArgsConstructor
@NoArgsConstructor
public class TEPCancelPrintDto implements PrintableDto {
	...
	public CustomerDocumentDto getDocumentDetails() {
		...
		customerDocument.setDocumentType(PrintDocumentTypeEnum.TEP_CANCEL.name());
	...
	public List<String> getTemplateName() {
		return List.of(FtlTemplateName.TEP_CANCEL_INVOICE_PRINT);
	}

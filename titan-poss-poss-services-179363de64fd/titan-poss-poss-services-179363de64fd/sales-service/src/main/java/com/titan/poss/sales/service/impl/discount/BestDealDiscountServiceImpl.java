...
/**
 * Service Class for Best Deal Discount
 * 
 * @author Mindtree Ltd.
 * @version 1.0
 */

@Service("salesBestDealDiscountServiceImpl")
public class BestDealDiscountServiceImpl implements DiscountService {

	@Autowired
	private DiscountUtilService discountUtilService;

	public BestDealDiscountServiceImpl(DiscountFactory discountFactory) {
		discountFactory.registerDiscountService(DiscountTypeEnum.BEST_DEAL_DISCOUNT.name(), this);
	}
	...
	public DiscountDetailsDaoExt addDiscount(SalesTxnDaoExt salesTxn, DiscountDetailDto discountDetail,
		...
		DiscountDetailsDaoExt discountDetailsDao = discountUtilService.createDiscountDetails(discountDetail, salesTxn,
				...
				DiscountInitialStatusEnum.BEST_DEAL_DISCOUNT.getDiscountInitialStatus(), null);

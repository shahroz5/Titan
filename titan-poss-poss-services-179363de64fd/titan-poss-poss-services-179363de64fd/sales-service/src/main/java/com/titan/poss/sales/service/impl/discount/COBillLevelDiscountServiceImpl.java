...
/**
 * Service Class for COBillLevelDiscount
 * 
 * @author Mindtree Ltd.
 * @version 1.0
 */

@Service("salesCOBillLevelDiscountServiceImpl")
public class COBillLevelDiscountServiceImpl implements DiscountService {

	@Autowired
	private DiscountUtilService discountUtilService;

	public COBillLevelDiscountServiceImpl(DiscountFactory discountFactory) {
		discountFactory.registerDiscountService(DiscountTypeEnum.CO_BILL_LEVEL_DISCOUNT.name(), this);
	}
	...
	public DiscountDetailsDaoExt addDiscount(SalesTxnDaoExt salesTxn, DiscountDetailDto discountDetail,
		...
		DiscountDetailsDaoExt discountDetailsDao = discountUtilService.createDiscountDetails(discountDetail, salesTxn,
				...
				DiscountInitialStatusEnum.CO_BILL_LEVEL_DISCOUNT.getDiscountInitialStatus(), null);

...
@AllArgsConstructor
@NoArgsConstructor
public class CMCancellationPrintDto implements PrintableDto{
	...
	public List<String> getTemplateName() {
		return List.of(FtlTemplateName.CASH_MEMO_CANCELLATION_INVOICE_PRINT);
	}
	...
	public CustomerDocumentDto getDocumentDetails() {
		...
		customerDocument.setDocumentType(PrintDocumentTypeEnum.CM_CANCELLATION.name());

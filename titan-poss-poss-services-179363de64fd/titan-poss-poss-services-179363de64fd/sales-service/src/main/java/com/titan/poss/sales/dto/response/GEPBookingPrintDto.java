...
@AllArgsConstructor
@NoArgsConstructor
public class GEPBookingPrintDto implements PrintableDto {
	...
	private GepResponseDto gepReponse;
	...
	public CustomerDocumentDto getDocumentDetails() {
		...
		customerDocument.setDocumentType(PrintDocumentTypeEnum.GEP.name());
	...
	public List<String> getTemplateName() {
		return List.of(FtlTemplateName.GEP_INVOICE_PRINT);
	}

...
import com.titan.poss.sales.dto.validators.UpiPaymentFieldsDto;
...
import com.titan.poss.sales.service.UpiPaymentService;

/**
 * Service class for UPI payment.
 * 
 * @author Mindtree Ltd.
 * @version 1.0
 */
@Service("salesUpiPaymentService")
public class UpiPaymentServiceImpl implements UpiPaymentService {
		public UpiPaymentServiceImpl(PaymentFactory paymentFactory) {
			paymentFactory.registerPaymentService(PaymentCodeEnum.UPI.getPaymentcode(), this);
		}
		...
		public SalesPaymentDto validateInputFields(PaymentCreateDto paymentCreateDto) {
			UpiPaymentFieldsDto upiPaymentFieldsDto = (com.titan.poss.sales.dto.validators.UpiPaymentFieldsDto) MapperUtil
					.getDtoMapping(paymentCreateDto, UpiPaymentFieldsDto.class);
			// validate fields
			upiPaymentFieldsDto.validateFields(upiPaymentFieldsDto);
		...
		public Map<PaymentDetailsDaoExt, List<PaymentItemMappingDaoExt>> paymentConfigValidations(String paymentCode,
			...
			paymentDetailsDao.setInstrumentType(paymentCode); // Upi
